...
module mojo_top_0 (
    ...
    output reg [7:0] matrixsel1,
    output reg [7:0] matrixrow1,
    output reg [7:0] matrixsel2,
    output reg [7:0] matrixrow2
  );
  ...
  wire [8-1:0] M_hangman_outsel1;
  wire [8-1:0] M_hangman_outsel2;
  wire [64-1:0] M_hangman_outpic1;
  wire [64-1:0] M_hangman_outpic2;
  wire [3-1:0] M_hangman_ct;
  reg [3-1:0] M_hangman_wrong;
  hangman_display_14 hangman (
    .clk(clk),
    .rst(rst),
    .wrong(M_hangman_wrong),
    .outsel1(M_hangman_outsel1),
    .outsel2(M_hangman_outsel2),
    .outpic1(M_hangman_outpic1),
    .outpic2(M_hangman_outpic2),
    .ct(M_hangman_ct)
  );
  ...
  always @* begin
    ...
    M_hangman_wrong = M_lives_q;
    matrixsel1 = M_hangman_outsel1;
    matrixrow1 = M_hangman_outpic1[(M_hangman_ct)*8+7-:8];
    matrixsel2 = M_hangman_outsel2;
    matrixrow2 = M_hangman_outpic2[(M_hangman_ct)*8+7-:8];
    spi_miso = 1'bz;
    spi_channel = 4'bzzzz;
    avr_rx = 1'bz;
  end
